...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, getRouterParams, createError, readBody, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery as getQuery$1, getResponseStatusText } from 'file:///Users/mgarciaalvarez/devel/Citizen-Voice/frontend/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/mgarciaalvarez/devel/Citizen-Voice/frontend/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/mgarciaalvarez/devel/Citizen-Voice/frontend/node_modules/devalue/index.js';
import { renderToString } from 'file:///Users/mgarciaalvarez/devel/Citizen-Voice/frontend/node_modules/vue/server-renderer/index.mjs';
import { renderSSRHead } from 'file:///Users/mgarciaalvarez/devel/Citizen-Voice/frontend/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/mgarciaalvarez/devel/Citizen-Voice/frontend/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///Users/mgarciaalvarez/devel/Citizen-Voice/frontend/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///Users/mgarciaalvarez/devel/Citizen-Voice/frontend/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/mgarciaalvarez/devel/Citizen-Voice/frontend/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file:///Users/mgarciaalvarez/devel/Citizen-Voice/frontend/node_modules/scule/dist/index.mjs';
import { klona } from 'file:///Users/mgarciaalvarez/devel/Citizen-Voice/frontend/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/mgarciaalvarez/devel/Citizen-Voice/frontend/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///Users/mgarciaalvarez/devel/Citizen-Voice/frontend/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file:///Users/mgarciaalvarez/devel/Citizen-Voice/frontend/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/mgarciaalvarez/devel/Citizen-Voice/frontend/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/mgarciaalvarez/devel/Citizen-Voice/frontend/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/mgarciaalvarez/devel/Citizen-Voice/frontend/node_modules/radix3/dist/index.mjs';
import { version, unref } from 'file:///Users/mgarciaalvarez/devel/Citizen-Voice/frontend/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///Users/mgarciaalvarez/devel/Citizen-Voice/frontend/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/mgarciaalvarez/devel/Citizen-Voice/frontend/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/Users/mgarciaalvarez/devel/Citizen-Voice/frontend/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/mgarciaalvarez/devel/Citizen-Voice/frontend","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/mgarciaalvarez/devel/Citizen-Voice/frontend/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/mgarciaalvarez/devel/Citizen-Voice/frontend/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/mgarciaalvarez/devel/Citizen-Voice/frontend/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/mgarciaalvarez/devel/Citizen-Voice/frontend/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
async function objectToFormData(obj) {
  ...
  if (typeof FormData === "undefined") {
    const { FormData: FormDataPonyfill } = await import('file:///Users/mgarciaalvarez/devel/Citizen-Voice/frontend/node_modules/formdata-node/lib/index.js');
...
const _IArSR6 = defineEventHandler(async (event) => {
...
const _lazy_rQh0Wa = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_rQh0Wa, lazy: true, middleware: false, method: undefined },
  { route: '/api/__api_party/:endpointId', handler: _IArSR6, lazy: false, middleware: false, method: "post" },
  { route: '/**', handler: _lazy_rQh0Wa, lazy: true, middleware: false, method: undefined }
];
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.png"},{"rel":"stylesheet","href":"https://unpkg.com/leaflet@1.9.3/dist/leaflet.css","integrity":"sha256-kLaT2GOSpHechhsozzB+flnD+zUyjE2LlfWPgU04xyI=","crossorigin":""}],"style":[],"script":[{"src":"https://unpkg.com/leaflet@1.9.3/dist/leaflet.js","integrity":"sha256-WBkoXOwTeyKclOHuWtc+i2uENFpDZ9YPdf5Hf+D7ewM=","crossorigin":""}],"noscript":[],"title":"Citizen Voice"};
...
const getClientManifest = () => import('file:///Users/mgarciaalvarez/devel/Citizen-Voice/frontend/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/mgarciaalvarez/devel/Citizen-Voice/frontend/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
